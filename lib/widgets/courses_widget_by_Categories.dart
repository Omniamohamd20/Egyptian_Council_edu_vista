...
class CoursesWidgetByCategories extends StatefulWidget {
  final String categoryId;

  const CoursesWidgetByCategories({ super.key, required this.categoryId});

  @override
  State<CoursesWidgetByCategories> createState() => _CoursesWidgetByCategoriesState();
}

class _CoursesWidgetByCategoriesState extends State<CoursesWidgetByCategories> {
